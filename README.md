...
## 13-6-2020 to 20-6-2020
I have prepared the file, ppt and testing the project. 

------------------------------------------------------------------------------------------------------------------------------
## 11-6-2020 to 12-6-2020
I have tested on Http Over SMS project.

-------------------------------------------------------------------------------------------------------------------------------
## 4-6-2020 to 10-6-2020
I have worked on Http over Sms.

------------------------------------------------------------------------------------------------------------------------------------
## 27-5-2020 to 3-6-2020
I have Worked on quiz System Project. This Project Used the Front end language like html,css, javascript, bootstrap and backend language like php.
...
### OBE:
  ...
  4. **Using Bloom’s Taxonomy**:<br />
     Bloom’s Taxonomy is a classification of the different objectives and skills that educators set for their students                (learning objectives).<br />
    These 6 levels can be used to structure the learning objectives, lessons, and assessments of your course:<br />     
     **1. Remembering**: Recognizing and recalling facts.<br />
     **2. Understanding**: Understanding what the facts mean.<br />
     **3. Applying**: Applying the facts, rules, concepts, and ideas.<br />
     **4. Analyzing**: Breaking down information into component parts.<br />
     **5. Evaluating**: Judging the value of information or ideas.<br />
     **6. Creating**: Combining parts to make a new whole.<br />
